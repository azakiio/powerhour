    ...
    <div>
      ...
      <div className="grid grid-cols-4 gap-2 not-prose select-none">
        {showList.map(({ id, title, date, url }) => (
          <div key={id} className="w-full flex justify-end relative rounded-lg overflow-clip ">
            <motion.div
              className="absolute inset-0 bg-black/50 flex flex-col justify-end p-2"
              initial={{ opacity: 0 }}
            ...
            <button
              ...
              className="absolute btn btn-xs btn-circle btn-primary m-2">
              <CgClose />
            </button>
