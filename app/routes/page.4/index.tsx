...
export default function AccordionExample() {
  ...
  return (
    <div className="slide">
      ...
      <AccordionCSS
        title="I'm trying to be accessible"
      ...
      >
        ...
        <ul>
          <li>
            Also a <code>max-height</code> accordion
          </li>
          <li>
          ...
          <li>
            There are some workarounds but none are pretty (I'll even say
            there's no clean css accordion)
          </li>
          <li>I promise this is important</li>
          <li>
            let's not think about how we would animate the accordion and instead
            look at what triggers the animation
          </li>
          <li>
            You might think it's the onClick of the accordion header, but it's
            actually the mounting and unmounting of the accordion content i.e
            this <code>{`{isOpen && ...`}</code>
          </li>
        </ul>
      </AccordionCSS>
    </div>
