...
export default function FramerAccordion() {
  ...
  return (
    <div className="slide">
        ...
        {isOpen1 && (
          ...
          >
            <div>
              ...
              <ul>
                <li>It actually can be that easy</li>
                <li>we can just use a conditional render for the contents</li>
                <li>
          ...
          {isOpen2 && (
            ...
            >
              <div className="pt-4">
                ...
                <p>
                  <code>AnimatePresence</code> allows components to animate out
                  when they're removed from the React tree.
                </p>
                <p>
      ...
      {/* `<AccordionMotion title="Test">Hello</AccordionMotion> */}
    </div>
  );
}
